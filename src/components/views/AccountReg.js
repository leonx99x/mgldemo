...
//temp solution for self-signed certificate
    ...
    return axios
      ...
      .then((response) => {
        if (response.data.response) {
          openNotification(t("Success"), t("E-mail sent successfully"), true);
          setMessage({
          ...
          openNotification(t("Fail!"), t("E-mail not verified!"), false);
          setMessage({
            style: "text-red-500",
            val: 0,
