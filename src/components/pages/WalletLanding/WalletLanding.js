...
import WalletConnectionManager from "../../component/WalletConnectionManager";
...
function Launch() {
  ...
  const [walletConnectMode, setWalletConnectMode] = useState(false);
  ...
  const handleWalletConnect = (payload) => {};
  ...
  function accessWallet() {
    setCreateMode(false);
    setAccessMode(true);
    setWalletConnectMode(false);
  }
  function walletConnect() {
    setCreateMode(false);
    setAccessMode(false);
    setPhraseMode(false);
    setWalletConnectMode(true);
  }
    ...
    <>
      <div className="relative">
        ...
        <div className="absolute top-0 w-full h-full flex flex-col ">
          ...
          {!accessMode && !createMode && !walletConnectMode ? (
                ...
                <Col xs={20} sm={16} md={12} lg={6} xl={6}>
                  <Row className="walletSelect div-wrap">
                    <Col className="div-relative">
                      ...
                      <Row className="text-grey wallet-detail ">
                        <Col span={24}>{t("WALLETCONNECT")}</Col>
                      </Row>
                      <Row className="wallet-detail header">
                        {t("Connect with WALLETCONNECT to trade assets.")}
                      </Row>
                      <Row className="wallet-detail wallet-button">
                        <Col span={24}>
                          <Button
